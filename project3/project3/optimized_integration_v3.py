"""
Integration helpers for v3 backtest engine.
"""
...
from optimized_backtest_v3 import OptimizedBacktestV3, RiskConfig


@dataclass
class OptimizedBacktestV3Result:
    performance: dict
    spread: pd.Series
    z_scores: pd.Series
    backtest: OptimizedBacktestV3
...
def run_optimized_backtest_v3(
    ...
    return OptimizedBacktestV3Result(
...
def summarize_performance_v3(result: OptimizedBacktestV3Result):
...
def plot_optimized_performance_v3(
    result: OptimizedBacktestV3Result,
    lookback_window: int,
    z_threshold: float,
    title: str,
):
